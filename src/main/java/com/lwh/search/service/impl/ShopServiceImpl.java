...
import com.lwh.search.dal.ShopModelMapper;
...
import com.lwh.search.service.SellerService;
import com.lwh.search.service.ShopService;
...
public class ShopServiceImpl implements ShopService {
     ...
     */
    @Override
    public Map<String, Object> searchByES1(BigDecimal longitude, BigDecimal latitude, String keyword, Integer orderby, Integer categoryId, String tags) throws IOException {
        ...
        List<ShopModel> shopModelList = shopIdList.stream().map(id -> get(id)).collect(Collectors.toList());
     ...
     *         "lang":"expression",
     *         "params": {"lat":31.23916171,"lon":121.48789499}
     *       }
     *     }
     *   },
     *   "query":{
     ...
     *           "gauss": {
     *             "location": {
     *               "origin": "31.23916171,121.48789499",
     *               "scale": "100km",
     *               "offset": "0km",
     *               "decay": 0.5
     *             }
     ...
     */
    @Override
    public Map<String, Object> searchByES2(BigDecimal longitude, BigDecimal latitude, String keyword, Integer orderby, Integer categoryId, String tags) throws IOException {
        Map<String, Object> result = new HashMap<>();
    ...
    @Override
    public Map<String, Object> searchByES3(BigDecimal longitude, BigDecimal latitude, String keyword, Integer orderby, Integer categoryId, String tags) throws IOException {
        Map<String, Object> result = new HashMap<>();
